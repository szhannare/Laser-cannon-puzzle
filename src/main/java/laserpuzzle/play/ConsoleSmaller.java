...
/**
 * Prints the interactive, smaller version of the game on the console.
 */
public class ConsoleSmaller {
    /**
     * Stores which columns have cannons.
     */
    private static int[] cannonCols=new int[]{1, 2};
    /**
     * Stores which rows have cannons.
     */
    private static int[] cannonRows=new int[]{1, 2, 4};
    /**
     * Stores which columns have active cannons in the even numbered turns.
     */
    private static int[] evenCannonCols=new int[]{1};
    /**
     * Stores which rows have active cannons in the even numbered turns.
     */
    private static int[] evenCannonRows=new int[]{2};
    /**
     * Stores which columns have active cannons in the odd numbered turns.
     */
    private static int[] oddCannonCols=new int[]{2};
    /**
     * Stores which rows have active cannons in the odd numbered turns.
     */
    private static int[] oddCannonRows=new int[]{1, 4};
    ...
    static PuzzleStateSmaller game=new PuzzleStateSmaller();
